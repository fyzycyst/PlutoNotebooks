...
on the time interval $t \in [0, 1]$ and $f(u, p, t) = \alpha u$
"""

# ╔═╡ 30c40ffc-30b7-4dc1-87e6-2093f6284b84
md"""
*We know the answer should be* $u(t) = u_0 exp(\alpha t)$
"""
...
# ╔═╡ db26b549-f182-47d8-9b4d-cec49cab68c3
md"""
...
git-tree-sha1 = "e63330a7d2dcc6245514d9035f4fab798ea6ca74"
...
deps = ["ADTypes", "Adapt", "ArrayInterface", "BandedMatrices", "ConcreteStructs", "DiffEqBase", "ForwardDiff", "LinearAlgebra", "NonlinearSolve", "PreallocationTools", "PrecompileTools", "RecursiveArrayTools", "Reexport", "SciMLBase", "Setfield", "SparseArrays", "SparseDiffTools", "TruncatedStacktraces", "UnPack"]
git-tree-sha1 = "0033bf62d3a0e709a3b12498141cc9bffb8fb7c5"
...
git-tree-sha1 = "f400009287afedef175058e64aadf7d41f593fef"
